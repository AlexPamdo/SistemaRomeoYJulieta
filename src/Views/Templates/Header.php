    ...
    <div class="offcanvas-body p-0">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <?php include './src/Assets/bootstrap-icons-1.11.3/book-fill.svg'; ?>
                    Catálogo
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <?php include './src/Assets/bootstrap-icons-1.11.3/people-fill.svg'; ?>
                    Clientes
                </a>
            </li>
            <li class="nav-item">
                <a id="facturas" class="nav-link-rj nav-link d-flex align-items-center gap-2" href="index.php?page=ventas">
                    <?php include './src/Assets/bootstrap-icons-1.11.3/file-earmark-bar-graph-fill.svg'; ?>
                    Facturas
                </a>
            </li>
            <li class="nav-item">
                <a id="envios" class="nav-link-rj nav-link d-flex align-items-center gap-2" href="index.php?page=envios">
                <?php include './src/Assets/bootstrap-icons-1.11.3/rocket-takeoff-fill.svg'; ?>
                    Envios
                </a>
            </li>
            <li class="nav-item">
