    ...
    <main class="container-fluid p-0 row m-0">
        ...
        <div class="col bg-custom-content p-0">
            ...
            <header class="bg-dark">
                <div class="p-3 d-flex justify-content-between align-items-center border-bottom">
                    <div class="d-flex align-items-center text-white">
                        ...
                        <h3 class="ms-3" data-intro="Este es el modulo de Supervisors, desde aqui se pueden crear y visulizar los supervisores en el sistema" data-step="1">Supervisores</h3>
                    </div>
            ...
            <div class="ms-sm-auto p-4 bg-custom-content">
                <!-- Barra de búsqueda y botón de crear supervisor -->
                <div class="d-flex justify-content-between mb-4">
                    <button type="button" class="btn btn-rj-blue" data-bs-toggle="modal" data-bs-target="#crear" data-intro="Desde este boton podemos registrar un nuevo supervisor en el sistema" data-step="2">
                        Registrar Supervisor <?php include './src/Assets/bootstrap-icons-1.11.3/plus-lg.svg'; ?>
                    </button>

                    <?php
                    require_once("src/Views/Supervisores/Crear.php");
                    include("src/Views/Supervisores/Editar.php");
                    ?>
                </div>
