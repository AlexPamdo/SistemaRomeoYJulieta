...
<body class="bg-body-secondary" data-bs-spy="scroll">
  ...
  <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
            ...
            <div class="ms-sm-auto p-4 bg-custom-content">
                ...
                <div class="d-flex justify-content-between mb-4">
                    <button type="button" class="btn btn-rj-blue" data-bs-toggle="modal" data-bs-target="#CrearModal">
                        Crear Cliente <?php include './src/Assets/bootstrap-icons-1.11.3/plus-lg.svg'; ?>
                    </button>

                    <?php
                        require_once("src/Views/Clientes/Crear.php")
                    ?>
                        ...
                        <tbody>
                            <?php foreach ($clientesData as $cliente) : ?>
                                <tr class="table-custom-row">
                                    ...
                                    <?php include("src/Views/Clientes/Editar.php"); ?>
                                    <?php include("src/Views/Clientes/Eliminar.php"); ?>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
    ...
    <?php
    include_once("src/Views/Clientes/Log.php");
