...
<div class="modal fade" id="materialesPatron<?php

use src\Model\PatronMaterialModel;

 echo $patron['id_patron']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="MaterialesPatronLabel" aria-hidden="true">
