<!--Modal de eliminar -->
<div class="modal fade" id="eliminar<?php echo ($proveedor['id_proveedor']) ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="container d-flex text-center flex-column">
                    ...
                    <div class="modal-footer">
                        <form class="needs-validation" action="index.php" method="get" novalidate>
                            ...
                            <input type="" name="page" value="proveedores">
