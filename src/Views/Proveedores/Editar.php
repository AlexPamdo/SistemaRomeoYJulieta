                        ...
                        <div>
                            ...
                            <div class="form-label input-group flex-nowrap m-2">
                                <input type="text" class="form-control campoEdit nameProveedorEdit"
                                    ...
                                    aria-describedby="addon-wrapping" name="nombre_proveedor_edit" id="nombre_edit"
                                    required >
                            ...
                            <div>
                                ...
                                <div class="form-label input-group flex-nowrap m-2">
                                    <input type="text" class="form-control campoEdit telfProveedorEdit"
                                        ...
                                        aria-describedby="addon-wrapping" name="telefono_proveedor_edit" id="telefono_edit"
                                        required >
                                    <div class="valid-feedback"></div>
                                </div>
                            ...
                            <div class="form-label input-group flex-nowrap m-2">
                                <input type="text" class="form-control campoEdit emailProveedorEdit"
                                    ...
                                    aria-describedby="addon-wrapping" name="gmail_proveedor_edit" id="correo_edit" required >
                                <div class="valid-feedback"></div>
                            </div>
                            ...
                            <div class="form-label input-group flex-nowrap m-2">
                                <input type="text" class="form-control campoEdit notasProveedorEdit"
                                    ...
                                    aria-describedby="addon-wrapping" name="notas_proveedor_edit" id="notas_edit"
                                    required >
                                <div class="valid-feedback"></div>
                            </div>
