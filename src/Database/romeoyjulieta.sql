...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2024 a las 06:11:26
...
(69, 'bfebfuvbefvfv vf', 2, 20, 0, 9, 0);
...
(1, 'v-30873556', 'Alexito', 'Pérez', '04125640755', 'Alex1234@gmail.com', 1, 1500, 0),
(5, 'v-13344799', 'Luis', 'Ramírez', '3344556677', 'luis.ramirez@example.com', 5, 1000, 1),
(19, '30899008', 'Alexa', 'Gollo', '04267504112', 'Hello@gmail.com', 18, NULL, 0);
...
(105, 'src/Assets/img/prendas/prendaDefault.png', 'Camisa Negra', 'Niño', 1, 1, -5, 1, 2, 23, 0),
...
CREATE TABLE `prenda_patron` (
  `id_prenda_patron` int(11) NOT NULL,
  `id_prenda` int(11) NOT NULL,
  `id_material` int(11) NOT NULL,
...
CREATE TABLE `proveedores` (
  `id_proveedor` int(11) NOT NULL,
  `rif_proveedor` varchar(11) NOT NULL,
...
(26, 'V-321321321', 'Telas Alex', '0450807444444', 'aeld@gmail.com', 'Exelente provedorr askjdksajdksajdskjdsakjd', 0),
(27, 'V-305223212', 'sis', '15465465465456454654', 'asdsad@gmail.comn', 'dfs', 1);
...
(145, 'Ana', 'Pere', 'Ane123@gmail.com', '$2y$10$K1.v2fWZmzBpEq0VWmAsMe5', 2, 'src/Assets/img/users/User_default_icon.png', 0),
...
--
ALTER TABLE `almacen`
  MODIFY `id_material` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `orden_entrega`
  MODIFY `id_orden_entrega` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `orden_pedido`
--
ALTER TABLE `orden_pedido`
  MODIFY `id_orden_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `prenda_patron`
  MODIFY `id_prenda_patron` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
