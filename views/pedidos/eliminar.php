<!--Modal de eliminar -->
<div class="modal fade" id="eliminar<?php echo ($pedido['id_pedido']) ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
